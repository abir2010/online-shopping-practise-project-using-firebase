  ...
  return (
    <div>
      <section class="relative">
        <nav class="flex justify-between bg-purple-300 border-b">
          <div class="px-12 py-1 flex w-full items-center">
            <NavLink
              class="lg:mr-8 2xl:mr-20 font-bold font-heading flex gap-2"
              to="/"
            >
              {/* <img
                class="h-9"
                src="https://tse4.mm.bing.net/th/id/OIP.1eWosz_YYbf4eiJHQicDVQHaGE?w=248&h=203&c=7&r=0&o=5&pid=1.7"
                alt=""
                width="auto"
              /> */}
              <p className="text-purple-700 mt-1">Online-Shop</p>
            </NavLink>
            <div class="hidden xl:flex max-w-xs py-3 pl-8 pr-2 bg-white rounded-lg">
              ...
              <input
                class="w-full border-0 focus:ring-transparent focus:outline-none py-2"
                type="text"
                placeholder="search here"
              />
              <select
                class="pl-1 pr-6 border-0 border-l border-gray-100 focus:border-gray-100 focus:ring-transparent focus:outline-none cursor-pointer"
                name=""
                id=""
              >
            ...
            <ul class="hidden xl:flex px-4 mx-auto font-semibold font-heading">
              <li class="mr-12">
                <NavLink class="hover:text-gray-600" to="/home">
                  Home
                </NavLink>
              </li>
              <li class="mr-12">
                <NavLink class="hover:text-gray-600" to="/shop">
                  Shop
                </NavLink>
              </li>
              <li class="mr-12">
                <NavLink class="hover:text-gray-600" to="/about">
                  About us
                </NavLink>
              </li>
              <li>
                <NavLink class="hover:text-gray-600" to="/details">
                  Order Details
                </NavLink>
              </li>
            </ul>
            <div class="hidden xl:flex items-center">
              ...
              <a class="flex items-center hover:text-gray-600" href="/">
                ...
                <span class="inline-block w-6 h-6 text-center bg-white rounded-full font-semibold font-heading">
                  3
                </span>
              </a>
            </div>
